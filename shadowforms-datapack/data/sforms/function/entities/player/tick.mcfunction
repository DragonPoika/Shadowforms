...
execute if entity @s[scores={sforms.used_snowball=1..}] at @s if entity @n[distance=0..,tag=sforms.gloombloom_blossom,type=snowball] run function sforms:items/gloombloom_blossom/at_spawn
